...
public class MultipleTreeViewer extends TreeViewer {
    ...
    public MultipleTreeViewer(int oreintation, BasicControlPalette.DisplayMode mode) {
        super(oreintation, mode);
        init();
    }

    public MultipleTreeViewer(Preferences preferences, int right) {
        super(preferences, right);
        init();
    }
